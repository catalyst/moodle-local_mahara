...
class mnetservice_local_mahara {

    private $wrap = null;

    public function __construct() {
        global $CFG;
        require_once($CFG->dirroot . '/mod/assign/submission/mahara/mnetlib.php');
        $this->wrap = new mnetservice_assign_submission_mahara();
    }

    public function donothing() {
        return call_user_func_array(array($this->wrap, __FUNCTION__), func_get_args());
    }

    public function can_view_view() {
        return call_user_func_array(array($this->wrap, __FUNCTION__), func_get_args());
    }
